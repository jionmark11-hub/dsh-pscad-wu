# update.ps1 — DSH-PSCAD-WU 更新脚本(已安装过的机器)
# 用法: powershell -ExecutionPolicy Bypass -File .\update.ps1
# 等效: git -C "$HOME\.dsh\.agent-presets\dsh-pscad-wu" pull
...
Write-Host ''
Write-Host '✔ 更新完成。重启 DSH 后,新会话选择 DSH-PSCAD-WU 即使用最新技能。' -ForegroundColor Green
